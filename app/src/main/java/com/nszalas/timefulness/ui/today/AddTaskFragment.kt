...
class AddTaskFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (args.currentTask === null) {
            ...
            setData()
            binding.deleteTaskButton.isVisible  = true
        }
