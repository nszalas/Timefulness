...
object Formatter {
    ...
    fun getHours(dateTime: DateTime) = dateTime.toString(getHourPattern())

    fun getTime(dateTime: DateTime) = dateTime.toString(getTimePattern())
    ...
    fun getTimeFromTS(context: Context, ts: Long) = getTime(getDateTimeFromTS(ts))
    ...
    fun getMonthName(context: Context, id: Int): String = context.resources.getStringArray(R.array.months)[id - 1]

    private fun getHourPattern() = PATTERN_HOURS_24

    private fun getTimePattern() = PATTERN_TIME_24
